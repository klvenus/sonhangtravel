...
export default function Footer({ logoUrl }: FooterProps) {
  return (
    <footer className="bg-[#0A3D3D] text-gray-200 pb-20 md:pb-0">
      {/* Mobile Footer */}
        ...
        <div className="px-4 py-6 space-y-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[#7EC8B8] text-[11px]">SON HANG TRAVEL COMPANY LIMITED</p>
            </div>
          </div>

          {/* Info */}
          <div className="space-y-2 text-[13px] text-[#A8D8CC]">
            ...
            <p className="text-[#7EC8B8] text-xs pl-5">(cách cửa khẩu Quốc Tế Móng Cái 100m)</p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <a href="tel:0986409633" className="flex items-center justify-center gap-1.5 bg-[#0D4F4F] text-[#A8D8CC] py-2.5 rounded-xl text-sm hover:bg-[#126060] transition-colors">
              📞 0986 409 633
            </a>
            <a href="https://zalo.me/0388091993" target="_blank" rel="noopener noreferrer" className="flex items-center justify-center gap-1.5 bg-[#0D4F4F] text-[#A8D8CC] py-2.5 rounded-xl text-sm hover:bg-[#126060] transition-colors">
              💬 0388 091 993
            </a>
          </div>
          ...
          <div className="flex items-center justify-between pt-2">
            <div className="flex gap-2">
              <a href="https://zalo.me/561113801789156735" target="_blank" rel="noopener noreferrer" className="w-9 h-9 bg-[#0D4F4F] rounded-full flex items-center justify-center hover:bg-blue-500 transition-colors text-xs font-bold">
                Z
              </a>
              <a href="#" className="w-9 h-9 bg-[#0D4F4F] rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                </svg>
              </a>
            </div>
            <a href="mailto:Lienhe@sonhangtravel.com" className="text-xs text-[#7EC8B8] hover:text-[#00CBA9]">
              Lienhe@sonhangtravel.com
            </a>
          </div>

          {/* Copyright */}
          <p className="text-center text-[#5A9E8F] text-[11px] pt-1">
      ...
      <div className="hidden md:block">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-5">
              <div className="flex items-center gap-3 mb-5">
                ...
                <div>
                  ...
                  <p className="text-[#7EC8B8] text-xs">SON HANG TRAVEL COMPANY LIMITED</p>
                </div>
              </div>
              ...
              <ul className="space-y-2.5 text-sm">
                ...
                <li className="flex items-start gap-2.5">
                  <svg className="w-4 h-4 text-[#00CBA9] shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" /><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                  <span>VP Đại Diện: 01 Xuân Diệu - Trần Phú - Móng Cái - Quảng Ninh <span className="text-[#7EC8B8]">(cách cửa khẩu Quốc Tế Móng Cái 100m)</span></span>
                </li>
                <li className="flex items-start gap-2.5">
                ...
                <li className="pt-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <a href="https://zalo.me/0388091993" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-white transition-colors">
                      <span>💬</span>
                      <span className="text-[#A8D8CC]">0388 091 993</span>
                    </a>
                  </div>
                </li>
              </ul>
            ...
            <div className="lg:col-span-4">
              ...
              <div className="flex gap-3">
                <a href="#" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#0D4F4F] rounded-full flex items-center justify-center hover:bg-blue-600 transition-colors" title="Facebook">
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                  </svg>
                </a>
                <a href="https://zalo.me/561113801789156735" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-[#0D4F4F] rounded-full flex items-center justify-center hover:bg-blue-500 transition-colors" title="Zalo OA">
        ...
        {/* Bottom Bar */}
        <div className="border-t border-[#0D4F4F]">
          <div className="container-custom py-4">
            <div className="flex flex-col md:flex-row justify-between items-center gap-2 text-sm text-[#7EC8B8]">
