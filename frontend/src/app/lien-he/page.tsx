        ...
        <div className="rounded-[32px] border border-emerald-100 bg-gradient-to-br from-emerald-50 via-white to-white p-6 shadow-sm md:p-8">
          <div className="grid gap-8 lg:grid-cols-[1fr_1fr] lg:items-center">
            <div>
              ...
              <div className="mt-5 rounded-3xl border border-rose-200 bg-gradient-to-br from-rose-50 via-pink-50 to-white p-5 text-sm leading-8 text-rose-700 shadow-inner whitespace-pre-line">
