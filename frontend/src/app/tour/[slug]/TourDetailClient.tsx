                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-6">
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-purple-100/50 rounded-xl p-3 border border-purple-200/50">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-xs text-gray-600 font-medium">Quy mô</span>
                    </div>
                    <p className="text-sm font-bold text-gray-900">{tourData.groupSize || '4-15 khách'}</p>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-orange-50 to-orange-100/50 rounded-xl p-3 border border-orange-200/50">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-xs text-gray-600 font-medium">Phương tiện</span>
                    </div>
                    <p className="text-sm font-bold text-gray-900">{tourData.transport || 'Xe du lịch'}</p>
                  </div>
                </div>

                {/* Mobile Price Card */}
                <div className="md:hidden bg-gradient-to-r from-[#00CBA9]/10 to-[#00A88A]/10 rounded-2xl p-4 mb-6 border border-[#00CBA9]/20">
