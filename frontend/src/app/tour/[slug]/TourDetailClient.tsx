            ...
            {tourData.images.map((img, idx) => (
              <button
                ...
                className={`shrink-0 w-16 h-16 rounded-lg overflow-hidden border-2 transition-all ${
                  currentImage === idx ? 'border-[#22C55E] scale-105' : 'border-gray-200'
                }`}
              >
          ...
          <div className="container mx-auto px-4 py-6 max-w-7xl">
            <div className="md:grid md:grid-cols-3 md:gap-10">
              ...
              <div className="md:col-span-2">
                ...
                {/* Mobile Price Card */}
                <div className="md:hidden bg-linear-to-r from-[#22C55E]/10 to-[#16A34A]/10 rounded-2xl p-4 mb-6 border border-[#22C55E]/20">
                    ...
                    {tabs.map((tab) => (
                      <button
                        ...
                        className={`px-3 py-3 text-xs sm:text-sm font-semibold rounded-xl transition-all duration-300 ${
                          activeTab === tab.id
                            ? 'bg-linear-to-r from-[#22C55E] to-[#16A34A] text-white shadow-lg'
                        ...
                        <div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            {tourData.highlights.map((highlight: string, idx: number) => (
                              <div key={idx} className="flex items-center gap-3 bg-gradient-to-r from-[#22C55E]/5 to-transparent p-3 rounded-xl">
                    ...
                    <div>
                        ...
                        {(showAllItinerary ? tourData.itinerary : tourData.itinerary.slice(0, 4)).map((item, idx) => (
                          <div key={idx} className="flex gap-4">
                            ...
                            <div className="flex flex-col items-center">
                              <div className="w-12 h-12 bg-gradient-to-br from-[#22C55E] to-[#16A34A] rounded-full flex items-center justify-center text-white font-bold shadow-lg">
                                {idx + 1}
                              </div>
                              {idx < tourData.itinerary.length - 1 && (
                                <div className="w-1 h-full bg-gradient-to-b from-[#22C55E] to-[#22C55E]/20 mt-2 rounded-full"></div>
                              )}
                            </div>

                            {/* Content */}
                            <div className="flex-1 pb-6">
                              <div className="bg-white border-2 border-gray-100 hover:border-[#22C55E]/30 rounded-2xl overflow-hidden transition-all duration-300 hover:shadow-lg">
                                {item.image && (
                                  <div className="relative h-48">
                                    ...
                                    />
                                    {item.time && (
                                      <div className="absolute top-3 left-3 bg-[#22C55E] text-white text-xs font-bold px-3 py-1.5 rounded-full shadow-lg flex items-center gap-1">
                                        <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                        {item.time}
                      ...
                      {tourData.itinerary.length > 4 && (
                        <button
                          ...
                          className="w-full py-4 text-[#22C55E] font-semibold border-2 border-[#22C55E] rounded-xl mt-6 hover:bg-[#22C55E] hover:text-white transition-all duration-300"
                        >
              ...
              <div className="hidden md:block">
                <div className="sticky top-24">
                  <div className="bg-white border-2 border-gray-100 rounded-2xl p-6 shadow-xl">
                    ...
                    {/* Price */}
                    <div className="mb-6 bg-linear-to-r from-[#22C55E]/10 to-[#16A34A]/10 rounded-xl p-4">
                      <div className="flex items-end gap-2 mb-2">
                    ...
                    <a 
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="w-full bg-linear-to-r from-[#22C55E] to-[#16A34A] hover:from-[#16A34A] hover:to-[#22C55E] text-white font-bold py-4 rounded-xl transition-all duration-300 shadow-lg hover:shadow-xl mb-3 transform hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2"
                    >
                    ...
                    <div className="flex gap-2 mb-4">
                      <a
                        ...
                        className="flex-1 flex items-center justify-center gap-2 border-2 border-[#22C55E] text-[#22C55E] py-3 rounded-xl hover:bg-[#22C55E]/10 transition-all font-medium"
                      >
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="md:hidden fixed bottom-16 left-0 right-0 bg-white border-t-2 border-gray-200 p-4 z-40 shadow-2xl">
        <div className="flex items-center gap-4">
          ...
          <a 
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="bg-linear-to-r from-[#22C55E] to-[#16A34A] text-white font-bold px-6 py-3.5 rounded-xl shadow-lg active:scale-95 transition-transform flex items-center gap-2"
          >
              ...
              {tourData.images.map((img, idx) => (
                <button
                  ...
                  className={`shrink-0 w-16 h-16 md:w-20 md:h-20 rounded-lg overflow-hidden transition-all ${
                    lightboxIndex === idx 
                      ? 'ring-2 ring-[#22C55E] ring-offset-2 ring-offset-black scale-110' 
