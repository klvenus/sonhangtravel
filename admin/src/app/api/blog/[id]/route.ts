...
export async function PUT(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    await revalidateProduction(['/blog', '/tintuc', `/blog/${updated.slug}`, '/uu-dai', '/an-sap-dong-hung'], { basePaths: [] });
...
export async function DELETE(_req: NextRequest, { params }: { params: Promise<{ id: string }> }) {
  ...
  try {
    ...
    await revalidateProduction(['/blog', '/tintuc', `/blog/${deleted.slug}`, '/uu-dai', '/an-sap-dong-hung'], { basePaths: [] });
