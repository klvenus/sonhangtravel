...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Ph\u00E2n lo\u1EA1i tour du l\u1ECBch';
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Logo, banner v\u00E0 th\u00F4ng tin website';
    displayName: 'C\u00E0i \u0111\u1EB7t Website';
  ...
  attributes: {
    ...
    siteName: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'S\u01A1n H\u1EB1ng Travel'>;
    tiktokUrl: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    youtubeUrl: Schema.Attribute.String;
    zaloNumber: Schema.Attribute.String;
  };
}
...
export interface ApiTourTour extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Qu\u1EA3n l\u00FD c\u00E1c tour du l\u1ECBch Trung Qu\u1ED1c';
    displayName: 'Tour Du L\u1ECBch';
    pluralName: 'tours';
    singularName: 'tour';
  };
  options: {
  ...
  attributes: {
    ...
    excludes: Schema.Attribute.Component<'tour.list-item', true>;
    featured: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    gallery: Schema.Attribute.Media<'images', true>;
    includes: Schema.Attribute.Component<'tour.list-item', true>;
    itinerary: Schema.Attribute.Component<'tour.itinerary-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::tour.tour'> &
      Schema.Attribute.Private;
    notes: Schema.Attribute.Component<'tour.list-item', true>;
    ...
    tourFile: Schema.Attribute.Media<'files'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
